...
| B3 documents 완료 · B4 hq-video(B2-03 · A3-04 · CameraWall·EquipmentCard) 완료 · B5 admin-masters(B4-03 · B4-04 · PageHeader·Select·KeyValueList·SiteProfileForm) 완료 · B6~B11 화면 실화면(자리+ 포함) · B12 오프라인 큐 · B13 로컬 알림 · B14 문서 생성기(설계서) · B15 마감 | 진행 예정 — 순서·의존은 계획 파일 |
