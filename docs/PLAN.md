...
- 2026-09-11 후속: [디자인 언어 개선안](design/OWNER-VISUAL-LANGUAGE-2026-09-11.md) 작성(텍스트에서 시각으로 — 측정 · 규칙 8 · 화면별 전/후 · 시안 4장 · 구현 C0~C4). 구현 미착수, 소유주 웹 comfortable 밀도 전환은 사용자 결정 대기.
