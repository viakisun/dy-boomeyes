...
| `A1-05` | 장비 상세 | A1 | `/a1/monitor/[device]` | site-safety | 1 | 1 | 1 (dev) | FR-002 FR-005 FR-007 FR-016 FR-036 | — |
...
| `B4-02` | 프로토콜 관리 | B4 | `/b4/protocols` | ops-admin | 1 | 1 | 1 (proto) | FR-020 | — |
...
| `B4-05` | 알림 기준 | B4 | `/b4/rules` | ops-admin | 1 | 1 | 1 (rules) | FR-006 FR-007 FR-011 FR-036 | — |
