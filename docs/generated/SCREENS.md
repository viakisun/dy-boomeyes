...
| `A4-03` | 투입 요청·배정 | A4 | `/a4/requests` | owner | 2 | 5 | 1 (inbox) | FR-026 | owner-contracts |
...
| `B1-06` | 임대 계약 | B1 | `/b1/leases` | control maintenance owner | 1 | 2 | 1 (lease) | FR-019 FR-024 FR-026 FR-043 | owner-contracts sites-assets-leases |
...
| `B1-13` | 투입 요청·배정 | B1 | `/b1/requests` | owner | 2 | 5 | 5 (inbox assign empty none error) | FR-026 | owner-contracts |
