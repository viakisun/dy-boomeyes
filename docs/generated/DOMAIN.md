...
| `ENT-08` | 알림 (Alert) | 1 | alert_id · 유형(9종) · 등급 · 확인 상태 · 발생 시각 | N─1 장비 · 1─N 업무 생성 | RDS |
...
| `ENT-19` | 이벤트 (Event) | 2 | event_id · 발생 시각(t0)·복기 창(±초) · 종류(알림 유형) · 장비 · 소스 4 참조(일반 CCTV·AI CCTV·바디캠·CPB 상태/부품 이력) 세그먼트 메타 · 연결(알림·업무·부품 이력) · 원본 보존 잠금 · 영상 확보 상태(pending\|partial\|secured\|unavailable — 업로드 대기·일부 확보·확보·확보 불가, 사건 상태와 별개 · 참고자료 v5.0 §15) | N─1 장비 · 1─1 알림 · 0─1 업무 · 1─N 부품 이력 | RDS · 세그먼트 메타는 S3(NFR-015 잠금) — 2단계 제안 (DISC-039) |
...
| 알림 9종 | 통신·GPS·전압·단선·고장코드·서류 미비·수송관·필터·3상 전원 (기준 등록: B4-05 · 3상은 FR-040, 임계 DISC-056) |
