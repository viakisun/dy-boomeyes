...
| `FR-002` | 실시간 장비 상태 조회 (통신·CAN·IO·전압·단선) | 1 | 기본 | 반영 | A1-05 A2-04 B1-02 B1-10 A4-08 | IF-004 IF-009 IF-010 | ACC-006 | demo-scripts pour-metrics video-basics driver-daily control-dashboard owner-experience |
...
| `FR-007` | 소모품(수송관·필터) 임계 알림 | 1 | 기본 | 반영 | A2-04 A1-05 B4-05 B1-12 A4-11 B1-10 A4-08 | IF-004 | ACC-006 | driver-daily pour-metrics demo-scripts video-basics admin-protocol-rules owner-experience |
...
| `FR-016` | 장비·현장 서류 관리 (완비율·만료 알림) | 1 | 기본 | 반영 | B1-05 B3-04 B4-06 A1-05 A4-10 B1-10 A4-08 | IF-009 IF-011 | — | documents owner-experience demo-scripts pour-metrics video-basics |
...
| `FR-019` | 임대 계약·재배치 관리 | 1 | 기본 | 반영 | B1-06 B1-10 A4-08 | IF-009 | — | sites-assets-leases owner-experience |
...
| `FR-025` | 사업주 보유·가용 현황 (가용/투입/정비 구분) | 2 | 제안 | 2단계 | A4-02 A4-05 B1-09 B1-10 A4-07 A4-08 | IF-009 | — | owner-experience |
...
| `FR-039` | 타설량 산출·가동률 — 수송관 진동 센서 기반 시간당 타설량(m³/h)·누적 타설량·가동률 | 2 | 제안 | 개발 단계 | B1-02 A1-05 A2-04 B4-07 A4-07 B1-10 A4-08 | IF-021 | — | control-dashboard demo-scripts owner-experience pour-metrics video-basics driver-daily equipment-parts |
| `FR-040` | 전력 상태 계측 — 3상 전압·전류 실측 · 결상·역상·과전압 판정 · 모터 구동 가능 여부 | 1 | 제안 | 개발 단계 | B1-02 A1-05 A2-04 B4-05 B1-10 A4-08 | IF-020 IF-002 | — | control-dashboard demo-scripts owner-experience pour-metrics video-basics driver-daily admin-protocol-rules |
...
| `FR-043` | 통신 단말기 탈부착 운영 — 미가동 장비 단말기 탈거·재장착과 월 유지비 관리 | 2 | 제안 | 미착수 | B4-03 B1-02 B1-06 B1-09 A4-02 B1-10 A4-08 | IF-009 | — | sites-assets-leases control-dashboard demo-scripts owner-experience pour-metrics |
...
| `A4-03` | 4.3.9 4.3.4 | OUT-009 | RFP-021 EXT-5 | DISC-026 DISC-051 DISC-060 | — |
...
| `B1-06` | 4.3.9 | OUT-009 | EXT-4 | DISC-037 DISC-059 DISC-060 | IF-009 |
