...
| `FR-037` | 오프라인 제출 큐 — 체크인·체크아웃·일일점검·서류를 저장 후 연결 시 순서대로 동기 | 1 | 기본 | 개발 단계 | A2-02 A2-03 A2-05 | IF-009 IF-011 | — | demo-scripts driver-daily |
...
| `A2-05` | 4.3.1 4.3.10 | OUT-001 | RFP-020 EXT-2 | DISC-016 DISC-045 DISC-046 | IF-009 IF-011 |
...
| `B1-08` | 5.3.1 | OUT-012 | RFP-008 | DISC-039 DISC-040 DISC-044 | IF-008 IF-009 IF-017 IF-018 |
...
| `B4-06` | 4.3.10 4.3.4 | OUT-010 | RFP-020 | DISC-016 DISC-046 | IF-009 IF-011 |
