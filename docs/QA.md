...
기본 상태 캡처는 예외 상태·육안 판정·실제 고객 확인을 대신하지 않는다. 예외 캡처, 독립 소유주 과제 검토, 성능, PDF 전페이지 판정은 실행 증거 묶음에 별도로 남긴다. 검토안 생성·검사는 [도구 안내](../tools/owner/README.md), 현재 실행 결과는 [실행 기록](plans/owner-demo-execution.md)을 따른다.
