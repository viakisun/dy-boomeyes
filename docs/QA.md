...
| 6 | e2e·캡처 | `pnpm e2e`(Playwright, 빌드 후) — 7역할 로그인·가드 스모크 · B1-02 마커 5/KPI/표 · B1-02M 열림/Esc · axe serious/critical 0(wcag2a·2aa·best-practice) · `pnpm capture` 라우트 × 상태 전수 | PR 차단(CI `e2e` 잡, shots 아티팩트) | 있음 · 시각 회귀(0.2%)·데모 장면은 W1 |
