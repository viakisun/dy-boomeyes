...
| PR7 `6d5665a` 지역 집계·마커 문법 | 0 | 0 | 149 | overview 48/48 | map 6/6 | (판정 대기) |
| PR8 `7825f5d` 헤더·띠·다크 지도 | 0 | 0 | 151 | overview·detail 64/64 | — | (판정 대기) |
| PR9(이 문서) | — | — | 106(JSON) | 144/144 재생성 · review | 30/30 | 증거 재커밋 |
