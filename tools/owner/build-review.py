...
NARRATION = {
    ...
    "overview": (45, "전국 지도에서 현장을 고르고, 현장의 호기를 눌러 영상과 정보를 봅니다.", "상태 띠로 가동·고장·점검·지연·보관 대수를 읽고, 현장 알약을 누르면 현장 지도와 호기 목록, 호기를 누르면 실시간 영상·계약·담당자·전압·서류가 한 패널에 옵니다. 보관 중이라는 표시만으로 투입 가능 여부를 판단하지 않습니다."),
    "fleet": (40, "호기 또는 현장명으로 검색하고 장비를 선택합니다.", "이상이 있는 장비뿐 아니라 정상 장비와 보관 장비도 같은 목록에서 찾습니다. 검색 결과 수와 선택한 장비의 현장을 함께 확인합니다."),
