...
:root { --ink:#16232a; --sub:#5c6b6e; --faint:#8fa0a4; --line:#dde3e4; --bg:#f8fafc; --card:#fff; --navy:#005679; --navy-bg:#e7f3fb; --danger:#b42318; --danger-bg:#fdecea; --ok:#1e7e4a; --warn:#8a5a00; --warn-bg:#fff4d6; }
