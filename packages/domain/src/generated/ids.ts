...
export type ScrId = keyof typeof SCR;
...
export type ApiId = keyof typeof API;
...
export const SCREENS = {
  ...
  'A1-05': { name: "장비 상세", surface: 'A1', app: 'pwa', route: "/a1/monitor/[device]", roles: ["site-safety"], phase: 1, wave: 1, default: 'dev', states: ["dev","pour","plite","stale","phase"] },
  ...
  'A3-02': { name: "현장 목록(본사)", surface: 'A3', app: 'pwa', route: "/a3/sites", roles: ["hq-safety"], phase: 1, wave: 2, default: 'sites', states: ["sites"] },
  'A3-03': { name: "현장 상세", surface: 'A3', app: 'pwa', route: "/a3/sites/[site]", roles: ["hq-safety"], phase: 1, wave: 2, default: 'site', states: ["site","normal"] },
  'A3-04': { name: "장비 열람", surface: 'A3', app: 'pwa', route: "/a3/sites/[site]/devices", roles: ["hq-safety"], phase: 1, wave: 2, default: 'dev', states: ["dev"] },
  'A3-05': { name: "업무(열람)", surface: 'A3', app: 'pwa', route: "/a3/tasks", roles: ["hq-safety"], phase: 1, wave: 2, default: 'inbox', states: ["inbox"] },
  'A3-06': { name: "기록", surface: 'A3', app: 'pwa', route: "/a3/records", roles: ["hq-safety"], phase: 1, wave: 2, default: 'rec', states: ["rec"] },
  'A4-01': { name: "로그인", surface: 'A4', app: 'pwa', route: "/a4/login", roles: ["owner"], phase: 2, wave: 4, default: 'login', states: ["owner","empty","error","boundaries","large","login"] },
  'A4-02': { name: "보유 장비", surface: 'A4', app: 'pwa', route: "/a4/fleet", roles: ["owner"], phase: 2, wave: 4, default: 'fleet', states: ["owner","empty","error","boundaries","large","fleet"] },
  'A4-03': { name: "투입 요청·배정", surface: 'A4', app: 'pwa', route: "/a4/requests", roles: ["owner"], phase: 2, wave: 5, default: 'inbox', states: ["inbox"] },
  'A4-04': { name: "운전자 배치", surface: 'A4', app: 'pwa', route: "/a4/drivers", roles: ["owner"], phase: 2, wave: 5, default: 'drivers', states: ["drivers"] },
  'A4-05': { name: "임대 계약", surface: 'A4', app: 'pwa', route: "/a4/leases", roles: ["owner"], phase: 2, wave: 5, default: 'lease', states: ["lease"] },
  'A4-06': { name: "운전자 서류", surface: 'A4', app: 'pwa', route: "/a4/drivers/docs", roles: ["owner"], phase: 2, wave: 5, default: 'docs', states: ["docs"] },
  ...
  'B0-01': { name: "웹 공통 로그인", surface: 'B0', app: 'web', route: "/login", roles: ["owner","control","hq-safety","site-safety","ops-admin","maintenance"], phase: 1, wave: 0, default: 'login-b1', states: ["owner","login-b1","login-b2","login-b3","login-b4","login-owner","login-maint"] },
  'B1-02': { name: "관제 대시보드", surface: 'B1', app: 'web', route: "/b1/dash", roles: ["control","maintenance","owner"], phase: 1, wave: 0, default: 'dash', states: ["owner","empty","error","boundaries","large","site","unit","dash"] },
  'B1-02M': { name: "카메라 영상 모달", surface: 'B1', app: 'web', route: "/b1/dash?cam=[camera]", roles: ["control","maintenance","owner"], phase: 1, wave: 1, default: 'cam', states: ["cam"] },
  'B1-03': { name: "수신함", surface: 'B1', app: 'web', route: "/b1/inbox", roles: ["control","maintenance","owner"], phase: 1, wave: 1, default: 'inbox', states: ["inbox","report"] },
  'B1-04': { name: "에스컬레이션", surface: 'B1', app: 'web', route: "/b1/escalation", roles: ["control","maintenance","owner"], phase: 1, wave: 1, default: 'esc', states: ["esc"] },
  'B1-05': { name: "서류 현황", surface: 'B1', app: 'web', route: "/b1/docs", roles: ["control","maintenance","owner"], phase: 1, wave: 2, default: 'docs', states: ["owner","empty","error","boundaries","large","docs"] },
  'B1-06': { name: "임대 계약", surface: 'B1', app: 'web', route: "/b1/leases", roles: ["control","maintenance","owner"], phase: 1, wave: 2, default: 'lease', states: ["lease"] },
  ...
  'B1-13': { name: "투입 요청·배정", surface: 'B1', app: 'web', route: "/b1/requests", roles: ["owner"], phase: 2, wave: 5, default: 'inbox', states: ["inbox","assign","empty","none","error"] },
  'B1-14': { name: "운전자 배치", surface: 'B1', app: 'web', route: "/b1/drivers", roles: ["owner"], phase: 2, wave: 5, default: 'drivers', states: ["drivers","expiring","empty","error"] },
  'B1-15': { name: "운전자 서류", surface: 'B1', app: 'web', route: "/b1/drivers/docs", roles: ["owner"], phase: 2, wave: 5, default: 'docs', states: ["docs","expiring","missing","error"] },
  ...
  'B3-02': { name: "현장 콘솔", surface: 'B3', app: 'web', route: "/b3/console", roles: ["site-safety"], phase: 2, wave: 4, default: 'console', states: ["console"] },
  'B3-03': { name: "업무", surface: 'B3', app: 'web', route: "/b3/tasks", roles: ["site-safety"], phase: 2, wave: 4, default: 'tasks', states: ["tasks"] },
  'B3-04': { name: "서류", surface: 'B3', app: 'web', route: "/b3/docs", roles: ["site-safety"], phase: 2, wave: 4, default: 'docs', states: ["docs"] },
  'B3-05': { name: "기록", surface: 'B3', app: 'web', route: "/b3/records", roles: ["site-safety"], phase: 2, wave: 4, default: 'rec', states: ["rec"] },
  'B3-06': { name: "쇼케이스", surface: 'B3', app: 'web', route: "/b3/showcase", roles: ["site-safety"], phase: 2, wave: 4, default: 'show', states: ["show"] },
  'B3-07': { name: "현장 부품 현황", surface: 'B3', app: 'web', route: "/b3/parts", roles: ["site-safety"], phase: 2, wave: 4, default: 'default', states: ["default"] },
...
export const OWNER_DEMO = [
  ...
  },
  {
    ...
    "web": "B1-11",
    "pwa": "A4-09",
    "question": "타설·설치 상황과 저장 영상을 볼 수 있나요?",
    "source_cells": [
      "H47:H55",
      "H72:H73",
      "H78:H79"
  ...
  },
  {
    ...
    "web": "B1-05",
    "pwa": "A4-10",
    "question": "필요한 제작증과 검사 성적서를 열 수 있나요?",
    "source_cells": [
      "H36",
      "H74",
      "H80"
