...
export const SCREENS = {
  ...
  'A1-04': { name: "관제(장비·영상)", surface: 'A1', app: 'pwa', route: "/a1/monitor", roles: ["site-safety"], phase: 1, wave: 1, default: 'monitor', states: ["monitor"] },
  'A1-05': { name: "장비 상세", surface: 'A1', app: 'pwa', route: "/a1/monitor/[device]", roles: ["site-safety"], phase: 1, wave: 1, default: 'dev', states: ["dev"] },
  ...
  'B0-01': { name: "웹 공통 로그인", surface: 'B0', app: 'web', route: "/login", roles: ["control","hq-safety","site-safety","ops-admin"], phase: 1, wave: 0, default: 'login-b1', states: ["login-b1","login-b2","login-b3","login-b4"] },
  ...
  'B1-08': { name: "이벤트 복기", surface: 'B1', app: 'web', route: "/b1/events/[event]", roles: ["control","maintenance"], phase: 1, wave: 2, default: 'default', states: ["default"] },
