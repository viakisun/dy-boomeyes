// mock MediaSource — 라이브 대체 루프 MP4 + poster 스틸 · 스냅샷 = 삽화 스틸(고정 시각은 UI가 표시) · 저장 영상 메타 (ADR-002 · specs/video-basics W2.6)
import type { Camera, MediaSource } from '@boomeyes/domain';
import { LOOP_MP4, STILL, type StillId } from '@boomeyes/video/assets';
