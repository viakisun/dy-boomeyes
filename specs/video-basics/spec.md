...
- **AC-3** Given CPB-003 When 장비 상세(A1-05) 로드 Then 텔레메트리(통신 · CAN · IO · 전압 342V · 단선 · 고장코드 E-021), 수송관·필터 도달률과 임계 상태, 장비 서류 완비율(FR-016)과 배정 운전자 교육 이수증 만료 임박 D-27(DOC-001), 저장 영상 목록(프로파일 P-SD → 서버·SD 탭)이 보인다 [FR-002, FR-007, FR-016, FR-005]
