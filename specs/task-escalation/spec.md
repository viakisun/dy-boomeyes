...
fr: [FR-008, FR-009, FR-011, FR-006, FR-002, FR-017, FR-018, FR-010, FR-024, FR-022, FR-033, FR-038]
---
...
- **AC-13** Given `?state=report`(현장 신고 업무 C-107 · 작업자 상태 이상 · CAM-3-2 · 영상 시점) When 수신함(B1-03) Then "알림에서 열린 업무"에 C-107이 현장 신고 유형·카메라·영상 시점과 함께 보이고 접수할 수 있다 [FR-038, FR-017]
